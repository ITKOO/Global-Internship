...
<body>
 	...
 	<!-- 상단  메뉴바 -->
   <jsp:include page="menubar_j.jsp" flush="false"/>
   <div id="fh5co-main">
...
<div id="myModal" class="modal">
  ...
  <div class="modal-content">
    ...
    <br><br>
    <form name="journalForm"  enctype="multipart/form-data" method="post" action="journalProc.jsp">
		<input type="file" name="filename1" size=40><br><input type="submit" value="올리기">
		<input type = "text" name = "journalText" id = "journalText">
		<br><br><br>
	</form>	
	...
	try{
		Connection conn = DriverManager.getConnection(url, id, pw); //실제연동시도
	  	String sql = "select * from journalPage;";
	  	PreparedStatement pstmt = conn.prepareStatement(sql);
	  	ResultSet rs=pstmt.executeQuery();
	  	while(rs.next()){
	  		journalText = rs.getString("journalText");
	  		imgAddress = rs.getString("imgAddress");
	  		out.println("<div class='item'><div class='animate-box'><a href='img/journal/" + imgAddress + 
	  				"' class='image-popup fh5co-board-img'>" + "<img src='img/journal/" 
	  				+ imgAddress + "' alt='Free HTML5 Bootstrap template'>" + "</a><div class='fh5co-desc'>" + journalText+ "</div></div></div>");
